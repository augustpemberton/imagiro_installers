...
Source: "..\..\resources\user\*"; DestDir: "{userappdata}\{#Publisher}\{#ProjectName}\"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist;
Source: "..\..\resources\system\*"; DestDir: "{commonappdata}\{#Publisher}\{#ProjectName}\"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist;
