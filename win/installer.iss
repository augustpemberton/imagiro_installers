...
Source: "..\..\build\{#ProjectName}_artefacts\{#BuildType}\Standalone\{#PluginName}.exe"; DestDir: "{commonpf}\{#Publisher}\{#PluginName}\{#PluginName}.exe"; Flags: ignoreversion recursesubdirs;
